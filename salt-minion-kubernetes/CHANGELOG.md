...
### salt-minion-kubernetes-image/v0.1.1
- Salt: 3008.2
...
### salt-minion-kubernetes-chart/v1.0.0
...
- Default image: `salt-minion-kubernetes:0.1.1` (see "Image releases" above for what that
  version carries)
